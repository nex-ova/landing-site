...
import { mainMenudata } from "../constant/alldata";
...
function Header() {
  ...
  return (
    <header
      className={`sticky-header main-bar-wraper ${isSticky ? "is-fixed" : ""}`}
    >
      <div class="main-bar">
        <div className="container">
          <div className="bottom-bar">
            ...
            <div className="header-menu-right">
              <div
                className="header-search-button search-box-outer"
        ...
        <div className="search-popup">
          <button className="close-search" onClick={addBodyClass}>
