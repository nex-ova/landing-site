...
export const teamdata = [
  {
    image: IMAGES.teamimg1,
    name: "Darlene Robertson",
    title: "Patient Advocates",
  },
  {
    image: IMAGES.teamimg2,
    name: "Cameron Williamson",
    title: "Patient Advocates",
  },
  {
    image: IMAGES.teamimg3,
    name: "Savannah Nguyen",
    title: "Patient Advocates",
  },
  {
    image: IMAGES.teamimg4,
...
export const blog2 = [
  {
    img: IMAGES.blogtwo1,
    title: "including proper hydration balanced nutrition.",
  },
  {
    img: IMAGES.blogtwo2,
    title: "the importance of regular check-ups, screenings.",
  },
  {
    img: IMAGES.blogtwo3,
    title: "Understand how a balanced diet can lower your.",
  },
];
...
export const blogdata = [
  {
    image: IMAGES.blogone1,
    date: "12",
    title: "How to Maintain A Balanced Diet And Exercise.",
  },
  {
    image: IMAGES.blogone2,
    date: "14",
    title: "Coping strategies for stress, anxiety, and depression.",
  },
  {
    image: IMAGES.blogone3,
    date: "16",
    title: "Latest medical technologies and treatments available.",
  },
  {
    image: IMAGES.blogone1,
    date: "12",
    title: "tips for maintaining a healthy lifestyle, from nutrition.",
  },
  {
    image: IMAGES.blogone2,
    date: "14",
    title: "Read inspiring stories from patients who have.",
  },
  {
    image: IMAGES.blogone3,
    date: "16",
    title: "Learn how to prevent common illnesses and manage.",
  },
  {
    image: IMAGES.blogone1,
    date: "12",
    title: "Gain insights from our medical professionals on a.",
  },
  {
    image: IMAGES.blogone2,
    date: "14",
    title: "Debunk common health myths and misconceptions.",
  },
  {
    image: IMAGES.blogone3,
    date: "16",
    title: "Stay healthy year-round with advice tailored to.",
  },
];
...
export const ourServices = [
  {
    ...
    descriptions:
      "Accelerate claims processing and denial management to improve cash flow and reduce billing errors.",
  },
  {
    icon: SVGICONS.preventiv,
    title: "Insurance Verification",
    columnstand: "two",
    descriptions:
      "Automate eligibility checks and prior authorizations to minimize delays and coverage issues.",
  },
  {
    icon: SVGICONS.surgical,
    title: "Patient Scheduling",
    columnstand: "three",
    descriptions:
      "Streamline appointments and reminders to reduce no-shows and free up staff for patient care.",
  },
  {
    icon: SVGICONS.medical,
    ...
    columnstand: "for",
    descriptions:
      "Connect EHR and practice systems for real-time, accurate records and a unified data flow.",
  },
  {
    icon: SVGICONS.preventiv,
    ...
    columnstand: "two",
    descriptions:
      "Create tailored workflows for your unique needs and scale automation seamlessly across departments.",
  },
];
...
export const whyChooseUs = [
  {
    svg: SVGICONS.expert,
    title: "Healthtech Experts",
    descriptions:
      "Our specialists bring decades of experience in healthcare automation, delivering innovative solutions tailored for real clinical environments.",
  },
  {
    svg: SVGICONS.beyond,
    title: "Secure & Compliant",
    descriptions:
      "We prioritize robust data protection and regulatory compliance at every step—so you can trust your systems and safeguard your patients with confidence.",
  },
];
...
export const stepProcess = [
  {
    number: "01",
    title: "Assess",
    descriptions: "We understand your needs and automation goals.",
  },
  {
    number: "02",
    title: "Automate",
    descriptions: "We deploy tailored solutions to streamline your workflows.",
  },
  {
    number: "03",
    title: "Excel",
    descriptions: "You deliver better care, supported by reliable automation",
  },
];
